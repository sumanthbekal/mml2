...
# Calculate and print the reconstructed ratings matrix using the important factors
reconstructed_ratings = U[:, :num_factors_to_keep] @ np.diag(sigma[:num_factors_to_keep]) @ VT[:num_factors_to_keep]
